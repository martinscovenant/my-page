    ...
    return (
        <div className="w-full h-screen bg-[#232f3e]">
            ...
            <div className="border lg:w-3/5 sm:w-4/5 mb-2 rounded absolute top-[10%] lg:mx-[20%] sm:mx-[10%] bg-white">
                ...
                <p>
                    <h1 className="text-center text-2xl font-semibold font-mono">CREATE ACCOUNT</h1>
                </p>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mx-[5%] my-[3%]">
                        ...
                        />
                        {error && formData.userMiddleName.trim() === '' && <p className='text-red-500 text-center'>Middle Name is required</p>}
                    </div>
                    <div className="mx-[5%] my-[3%]">
                        <input
                            type="text"
                    ...
                    <div className="mx-[5%] my-[3%] relative">
                        ...
                        {error && formData.userPassword.trim() === '' && <p className='text-red-500 text-center'>Please set up your password</p>} 
                    </div>
